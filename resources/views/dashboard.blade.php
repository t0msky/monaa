...
<div class="br-mainpanel">
  ...
  <div class="br-pagetitle hidden-xs-down">
    ...
    <div class="form-layout-footer mg-l-auto">
      <a href="<?php echo env('BASE_URL');?>addnewjob" class="btn btn-info"><i class="fas fa-plus tx-14 mg-r-15"></i>Add New Job</a>
    </div>
    ...
    <div class="row no-gutters widget-1 shadow-base">
      <div class="col-sm-6 col-lg-4">
        <div class="card">
          ...
          <div class="card-body">
            <div class="tx-24 tx-bold tx-inverse tx-lato tx-spacing-4">SGD</div> <div class="tx-24 tx-bold tx-inverse tx-lato tx-spacing-4"><?php echo number_format($totalStsCurrentMonth * 0.8,2);?></div>
          </div><!-- card-body -->
          <div class="card-footer">
            ...
            <div>
              <div class="tx-14 tx-right">20% Discount</div>
              <h6 class="tx-teal pd-t-5 tx-14 tx-right">SGD <?php echo number_format($totalStsCurrentMonth * 0.2,2);?></h6>
            </div>
          </div><!-- card-footer -->
        </div><!-- card -->
      </div><!-- col-3 -->
      <div class="col-sm-6 col-lg-4 mg-t-1 mg-sm-t-0">
        <div class="card">
          ...
          <div class="card-body">
            <div class="tx-24 tx-bold tx-inverse tx-lato tx-spacing-4">SGD</div> <div class="tx-24 tx-bold tx-inverse tx-lato tx-spacing-4"><?php echo number_format($totalPilotageCurrentMonth * 0.8,2);?></div>
          </div><!-- card-body -->
          <div class="card-footer">
            <div>
              <span class="tx-14">Gross Charges</span>
            ...
            <div>
              <div class="tx-14 tx-right">20% Discount</div>
              <h6 class="tx-teal pd-t-5 tx-14 tx-right">SGD <?php echo number_format($totalPilotageCurrentMonth * 0.2,2);?></h6>
            </div>
          </div><!-- card-footer -->
        </div><!-- card -->
      </div><!-- col-3 -->
      <div class="col-sm-6 col-lg-4 mg-t-1 mg-lg-t-0">
        <div class="card">
          ...
          <div class="card-body">
            <div class="tx-24 tx-bold tx-inverse tx-lato tx-spacing-4">SGD</div> <div class="tx-24 tx-bold tx-inverse tx-lato tx-spacing-4"><?php echo number_format( ($totalStsCurrentMonth + $totalPilotageCurrentMonth) * 0.8 ,2);?></div>
          </div><!-- card-body -->
          <div class="card-footer">
            <div>
              <span class="tx-14">Total Gross</span>
              <h6 class="tx-inverse pd-t-5 tx-14">SGD <?php echo number_format( ($totalStsCurrentMonth + $totalPilotageCurrentMonth),2);?></h6>
            </div>
            <div>
              <div class="tx-14 tx-right">Total Discount</div>
              <h6 class="tx-teal pd-t-5 tx-14 tx-right">SGD <?php echo number_format( ($totalStsCurrentMonth + $totalPilotageCurrentMonth) * 0.2 ,2);?></h6>
            </div>
          </div><!-- card-footer -->
        </div><!-- card -->
      </div><!-- col-3 -->
    ...
    <div class="row no-gutters widget-1 mg-t-20 shadow-base">
      <div class="col-sm-6 col-lg-4">
        <div class="card">
          ...
          <div class="card-body">
            <div class="tx-24 tx-bold tx-inverse tx-lato tx-spacing-4">SGD</div> <div class="tx-24 tx-bold tx-inverse tx-lato tx-spacing-4"><?php echo number_format($totalStsCurrentYear * 0.8,2);?></div>
          </div><!-- card-body -->
          <div class="card-footer">
            <div>
              <span class="tx-14">Gross Charges</span>
            ...
            <div>
              <div class="tx-14 tx-right">20% Discount</div>
              <h6 class="tx-teal pd-t-5 tx-14 tx-right">SGD <?php echo number_format($totalStsCurrentYear * 0.2,2);?></h6>
            </div>
          </div><!-- card-footer -->
        </div><!-- card -->
      </div><!-- col-3 -->
      <div class="col-sm-6 col-lg-4 mg-t-1 mg-sm-t-0">
        <div class="card">
          ...
          <div class="card-body">
            <div class="tx-24 tx-bold tx-inverse tx-lato tx-spacing-4">SGD</div> <div class="tx-24 tx-bold tx-inverse tx-lato tx-spacing-4"><?php echo number_format($totalPilotageCurrentYear * 0.8,2);?></div>
          </div><!-- card-body -->
          <div class="card-footer">
            <div>
              <span class="tx-14">Gross Charges</span>
            ...
            <div>
              <div class="tx-14 tx-right">20% Discount</div>
              <h6 class="tx-teal pd-t-5 tx-14 tx-right">SGD <?php echo number_format($totalPilotageCurrentYear * 0.2,2);?></h6>
            </div>
          </div><!-- card-footer -->
        </div><!-- card -->
      </div><!-- col-3 -->
      <div class="col-sm-6 col-lg-4 mg-t-1 mg-lg-t-0">
        <div class="card">
          ...
          <div class="card-body">
            <div class="tx-24 tx-bold tx-inverse tx-lato tx-spacing-4">SGD</div> <div class="tx-24 tx-bold tx-inverse tx-lato tx-spacing-4"><?php echo number_format( ($totalStsCurrentYear + $totalPilotageCurrentYear) * 0.8 ,2);?></div>
          </div><!-- card-body -->
          <div class="card-footer">
            <div>
              <span class="tx-14">Total Gross</span>
            ...
            <div>
              <div class="tx-14 tx-right">Total Discount</div>
              <h6 class="tx-teal pd-t-5 tx-14 tx-right">SGD <?php echo number_format( ($totalStsCurrentYear + $totalPilotageCurrentYear) * 0.2 ,2);?></h6>
            </div>
          </div><!-- card-footer -->
        </div><!-- card -->
      </div><!-- col-3 -->
