                    ...
                    <div class="col-lg-6">
                      <div class="form-group mg-b-10-force">
                        ...
                        <div class="input-group">
                          ...
                          ?>
                          <input id="time-02"  name="job_complete_time"  type="text" class="form-control" placeholder="Set time" value="<?php echo $job_complete_time;?>" <?php echo $disabled_completed;?>>
                      ...
                      <div class="form-group mg-b-10-force">
                        <label class="form-control-label">Total Exposure Hours <span class="tx-danger">*</label>
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="job_hour">
                          </div><!-- input-group -->
                      </div>
                    </div><!-- col-6 -->
                  </div><!-- row -->
